...
\cline{3-7}
\multirow{5}{*}{\rotatebox[origin=c]{90}{\textbf{Ground truth}}} & \multicolumn{1}{c|}{0} & 99.9425\% & 0.0013\% & 0.0520\% & 0.0023\% & 0.0019\% \\
& \multicolumn{1}{c|}{1} & 42.2871\% & 25.3613\% & 5.0595\% & 17.7104\% & 9.5818\% \\
& \multicolumn{1}{c|}{2} & 55.7426\% & 1.5083\% & 38.7625\% & 3.0655\% & 0.9211\% \\
& \multicolumn{1}{c|}{3} & 51.1633\% & 8.5761\% & 23.1915\% & 10.7018\% & 6.3673\% \\
& \multicolumn{1}{c|}{4} & 25.0670\% & 0.8913\% & 3.9260\% & 6.1079\% & 64.0078\% \\
\end{tabular}
